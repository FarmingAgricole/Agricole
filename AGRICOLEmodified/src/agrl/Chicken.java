...
public class Chicken extends Shape implements Animal{
	...
	public Chicken(String name, int healthpoint, int age){ /* Créer un cochon dont on selectionne les points de vie, l'age et dont les points de vie max sont prédéfinis */
		super(healthpoint,maxhealth);
		this.name = name ;
		this.age = age ;
	}
